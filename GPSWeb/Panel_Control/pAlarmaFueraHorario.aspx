<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pAlarmaFueraHorario.aspx.vb" Inherits="GPSWeb.pAlarmaFueraHorario" MasterPageFile="~/Panel_Control/SiteMaster.Master" %>
...
<div style="margin-left:30px; width:100%; height:100%;">
 ...
 <h3>Configurar Alarma de Uso de Movil fuera de Horario</h3>
  <h5>Seleccione uno o más vehiculos a los que quiera asignarles la alarma, y los dias y rango de horario que se controlarán. Recibira una alarma si el movil es usado en esos días.</h5>
  <asp:Label ID="lblError" runat="server" Text="" Font-Bold="true" ForeColor="Red" Font-Size="12px"></asp:Label>
   ...
   <table style="width:100%; vertical-align:middle; font-size:12px; font-family:Arial;" cellspacing="8" cellpaging="5">
     <tr><td colspan="2">
   ...
   <div style="height:200px;overflow-y: scroll; font-family:Arial;width:320px; border-color:LightGray; border-width:1px; border-style:solid;">       
     <asp:DataList ID="DataListVehiculos" runat="server" DataKeyField="veh_id" CellSpacing="5" CellPadding="5"  Font-Names="Arial" Width="300px">
             <ItemTemplate>           
     ...
     <tr><td colspan="2"><span style="font-weight:bold;">Descripción para la Alarma:</span></td>
     </tr>
     <tr><td colspan="2"><asp:TextBox ID="txtDescripcion" runat="server" Width="350px" MaxLength="50"></asp:TextBox></td></tr>
     <tr><td colspan="2"><span style="font-weight:bold;">Controlar Alarma:</span></td>
     </tr>
      ...
      <tr><td colspan="2"> 
          <asp:RadioButtonList ID="rdbTipo" runat="server" CellSpacing="5" CellPadding="3"  Font-Names="Arial" AutoPostBack="true">
              ...
              <asp:ListItem Value="3">Todos los Días</asp:ListItem>
     ...
     <tr><td colspan="2"><span style="font-weight:bold;">En el siguiente Rango Horario:</span></td>
     </tr>
 ...
 <tr><td colspan="2"><span style="font-weight:bold;">Velocidad a partir de la cual considerar que esta activo:</span></td>
     </tr>
  <tr><td colspan="2"><asp:TextBox ID="txtVelocidad" runat="server" Width="100px" MaxLength="10" Text="20"></asp:TextBox>
      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Ingrese Velocidad. Mayor a Cero." ControlToValidate="txtVelocidad"></asp:RequiredFieldValidator>
  </td></tr>
     <tr><td colspan="2"><span style="font-weight:bold;">Cantidad de Minutos a partir de los cuales considerar que esta activo:</span></td>
     </tr>
  <tr><td colspan="2"><asp:TextBox ID="txtMinutos" runat="server" Width="100px" MaxLength="10"></asp:TextBox></td></tr>
<tr><td colspan="2"><span style="font-weight:bold;">Notificar por e-mail:</span></td></tr>
