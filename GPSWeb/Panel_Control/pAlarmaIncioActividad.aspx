<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pAlarmaIncioActividad.aspx.vb" Inherits="GPSWeb.pAlarmaIncioActividad" MasterPageFile="~/Panel_Control/SiteMaster.Master" %>
...
<div style="margin-left:30px; width:100%; height:100%;">
 ...
 <h3>Configurar Alarma de Uso de Inicio de Actividad Diaria</h3>
  <h5>Seleccione uno o más vehículos a los que quiera asignarles la alarma, y los días y la hora de inicio de actividad de esos días. Recibira una alarma si el vehículo comienza a usarse en el horario establecido.</h5>
  <asp:Label ID="lblError" runat="server" Text="" Font-Bold="true" ForeColor="Red" Font-Size="12px"></asp:Label>
   ...
   <table style="width:100%; vertical-align:middle; font-size:12px; font-weight:bold;" cellspacing="8" cellpaging="5">
     ...
     <tr><td colspan="2">  <asp:Panel ID="PanelGrupo" runat="server">
   ...
   <div style="height:200px;overflow-y: scroll; font-family:Arial;width:320px; border-color:LightGray; border-width:1px; border-style:solid;"">       
     ...
     <tr><td colspan="2"><asp:TextBox ID="txtDescripcion" runat="server" Width="350px" MaxLength="50"></asp:TextBox></td></tr>
        ...
        <tr><td colspan="2"><span>Disparar Alarma para los días:</span></td>
     </tr>
     <tr><td colspan="2" >  
     ...
     <tr><td colspan="2"><span>Hora de Incio de Actividad:</span></td>
     </tr>
    
       <tr><td>   <asp:DropDownList ID="ddlhoraDesde" runat="server" Width="60px">
     ...
     <td> <asp:CheckBox ID="chkInicioAntes" runat="server" Text="Controlar también si Inicia antes de esta hora" /> </td>
         </tr>
