<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pReportes old 2.aspx.vb" Inherits="GPSWeb.pReportes"  MasterPageFile="~/Panel_Control/SiteMaster.Master" Culture="Auto" UICulture="Auto"%>
...
<script type="text/javascript">
   /*  window.onload = function() {
     window.frames['ctl00_ContentPlaceHolder1_ReportViewer1TouchSession0'].window.frames['report'].document.getElementById('oReportCell').style.width = '100%';
     $(window.frames[0].window.frames['ctl00_ContentPlaceHolder1_ReportViewer1TouchSession0'].document.getElementById('oReportDiv')).attr('style', 'overflow: none;');
...
*/
  ...
  /* window.onload =
    function() {
    $(window.frames[0].window.frames['report'].document.getElementById('oReportDiv')).attr('style', 'overflow: none;');
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <div style="border: thin solid #00A6C6;">
    <asp:Label ID="Label3" runat="server" Text="Reportes de Rutina:" Font-Bold="true" CssClass="fontRegion"></asp:Label>
       &nbsp;<asp:LinkButton ID="LinkButton2" runat="server">[+/-]</asp:LinkButton>
      <asp:Panel ID="PanelRutina" runat="server">
      <asp:Panel ID="PanelMoviles" runat="server"><br />
 ...
 <div style="border: thin solid #00A6C6; height:500px; width:100%">
           <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" ProcessingMode="Remote" ShowPrintButton="true" ExportContentDisposition="AlwaysAttachment" ShowFindControls="False" ShowPageNavigationControls="true"
       AsyncRendering="true" Font-Size="8pt" SizeToReportContent="true" Width="100%" Height="100%" ShowExportControls="true" ShowParameterPrompts="false" ShowBackButton = "true" ZoomPercent="75" ZoomMode="Percent">         
    </rsweb:ReportViewer>
