Public Class contacto
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Dim Mensaje As String = "Nueva consulta desde el sitio de RastreoUrbano<br /><br /><strong>Datos Personales</strong><br />Nombre: " + nombre.Text.Trim() & _
                     "<br /><br /><strong>Información Contacto</strong><br /><br />Télefono: " + telefono.Text.Trim() & _
                   "<br />E-Mail: " + email.Text.Trim() & _
                     "<br />Pide Resupuesto Para: " + cboPresupuesto.SelectedValue & _
                      "<br />Consulta: " + txtmensaje.Text.Trim()
            ...
            Catch smtpExc As System.Net.Mail.SmtpException
                lblResultado.Text = "Ocurrio un error Intenta más tarde."
                Throw smtpExc
            End Try
