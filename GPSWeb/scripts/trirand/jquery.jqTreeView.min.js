...
"use strict";
	...
	TreeView.prototype.render = function() {
		var sb = [];
		var o = this.options;
		sb.push("<div id='" + o.id +  " _wrapper' class='ui-widget ui-jqtreeview-wrapper' style='width:{1}; height:{2};'>");
		sb.AppendFormat("<div id='{0}_wrapper' class='ui-widget ui-jqtreeview-wrapper' style='width:{1}; height:{2};'>",
      _model.ID, _model.Width.ToString(), _model.Height.ToString());
      sb.AppendFormat("<ul id='{0}'></ul>", _model.ID);
      sb.Append("</div>");
	}
